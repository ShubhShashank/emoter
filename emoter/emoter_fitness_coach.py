...
def trainDatabase():
    ...
    texts_encouragement_needed = [
                     ...
                     ("I'm not really doing that great right now", """I'm sorry to hear that. Let's get that fixed right away. Can you tell me anything more?"""),
                     ("I don't feel good about myself lately.", """I'm sorry to hear that. We can get that worked out. Can you tell me anything more?"""),
                     ("I'm feeling bad about myself.", """I'm sorry to hear that. We can get that worked out. Can you tell me anything more?"""),
                     ("I feel bad today.", """I'm sorry to hear that. We can get that worked out. Can you tell me anything more?"""),
                     ("I'm not feeling too good lately.", """I'm sorry to hear that. We can get that worked out. Can you tell me anything more?"""),
                     ("I have been feeling kind of down.", """I'm sorry to hear that. We can get that worked out. Can you tell me anything more?"""),
                     ("I've been feeling bad.'", """I'm sorry to hear that. We can get that worked out. Can you tell me anything more?"""),
    ...
    texts_tasks =    [
                     ...
                     ("What can you do?", "Good question! I can do a lot of things. Specifically, I'm a fitness coach. And I have personal assistant capabilities! I'm awesome."),
                     ("What are some things you can do?", "Good question! I can do a lot of things. Specifically, I'm a fitness coach. And I have personal assistant capabilities! I'm awesome."),
                     ("Help me learn to eat better please.", "I can do that for you, but I need you to give me some details about yourself first. Can I ask you a few personal questions?"),
                     ("How do you get more muscle?", "I can answer that for you, but I need you to give me some details about yourself first. Can I ask you a few personal questions?"),
                     ("How many glasses of water should I drink in a day?", "I can answer that for you, but I need you to give me some details about yourself first. Can I ask you a few personal questions?"),
                     ("I want to learn better nutrition.", "I can answer that for you, but I need you to give me some details about yourself first. Can I ask you a few personal questions?"),
                     ("I want to learn more about my body.", "I can answer that for you, but I need you to give me some details about yourself first. Can I ask you a few personal questions?")
    ...
    texts_salutations = [
                        ...
                        ("Thanks a lot.", "You're so welcome!"),
                        ("Thank you very much.", "You're so welcome!"),
                        ("Bye-bye.", "Good-bye! Come again."),
                        ("See you.", "Good-bye! Come again."),
                        ("Cya.", "Good-bye! Come again."),
                        ("Cya later", "Good-bye! Come again."),
                        ("Good-bye.", "Good-bye! Come again."),
                        ("Goodbye!.", "Good-bye! Come again."),
                        ("Okay thanks.", "You're so welcome!"),
                        ("Oh alright.", "Yup yup!"),
                        ("Okay then.", "Yup yup!"),
